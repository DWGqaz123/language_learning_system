...
import './assistant_notification.css'
    ...
    <div className="layout">
      <aside className="sider">
        ...
        <ul className="menu">
          ...
          <li className="active"><Link to="/assistant/assistant-notification">通知中心</Link></li>
      ...
      <main className="main">
        <header className="header">
          <h2>语言学习机构后台管理系统</h2>
          <h2>欢迎您，{storedUser.username || '助教'}！这是您的通知中心。</h2>
        </header>
